                    ...
                    @forelse($items as $item)
                        <tr class="bg-white dark:bg-gray-800">
                            ...
                            <td class="flex items-center justify-center">
                                <a x-on:click="$dispatch('open-modal', 'items-edit-{{ $item->id }}')" href="#" class="inline-flex items-center px-4 py-2 rounded-md">
                                ...
                                <a wire:click="deleteItem({{ $item->id }})" wire:confirm="Are you sure you want to delete this item?" href="#" class="inline-flex items-center px-4 py-2 rounded-md">
