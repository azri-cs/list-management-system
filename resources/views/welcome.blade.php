            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        <div class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-lg ring-1 ring-gray-900/5 transition duration-300 hover:bg-gray-50 dark:bg-gray-800 dark:ring-gray-800 dark:hover:bg-gray-700">
                            <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-red-500/10 sm:size-16">
